...
public class ComputerMode extends BorderPane {
    ...
    public void incrementPersonScore() {
        /*int currentScore = Integer.parseInt(p1Score.getText());
        p1Score.setText(Integer.toString(currentScore + 1));*/
        personScore ++;
    }

    public void incrementComputerScore() {
       /* int currentScore = Integer.parseInt(cScore.getText());
        cScore.setText(Integer.toString(currentScore + 1));*/
       computerScore ++;
    }
}
