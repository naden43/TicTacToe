...
public class Online_mode extends BorderPane {
    ...
    protected final Label LTime;

    public Online_mode(Stage stage) {
        ...
        computer_view.setImage(new Image(getClass().getResource("Images/man2.png").toExternalForm()));
       ...
       for (int i = 0; i < 9; i++) {
        ...
        LTime.setLayoutX(276.0);
        LTime.setLayoutY(93.0);
        LTime.setStyle("-fx-font-size: 15;");
        LTime.setText("00:57");
        setCenter(pane);
